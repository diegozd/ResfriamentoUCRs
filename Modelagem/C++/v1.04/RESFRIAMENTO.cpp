        ...
        {   //início do loop de espaço
            ...
            {	
                ...
                {   //houve ebulição
                    ...
                    if (GeraVap[D.ii][D.jj] > D.mliq[D.ii][D.jj])
                    {
						...
						/*cout << "[ii] " << D.ii << " [jj] " << D.jj << endl;
						cout << "Tempo decorrido " << D.ii*D.dt/60 << endl;
						cout << "Vazão de vapor " << GeraVap[D.ii][D.jj] << endl;
						cout << "Vazão de líquido " << D.mliq[D.ii][D.jj] << endl;
						system ("PAUSE");*/
            ...
            else if( ((NIVEL[D.ii] / D.dL) >= aux) && ((NIVEL[D.ii]/D.dL) < (aux + 1)) && (NIVEL[D.ii] < D.AltLeito) && (D.mliq[D.ii][D.jj] > 0) )
            {
                ...
                //{					
                    ...
                    //L = Lvelho + D.mliq[D.ii][D.jj]*D.dt / (D.eps * D.Asr * rohl);      //Aumento de nível devido a quantidade de água inserida [m]
					L = D.mliq[D.ii][D.jj]*D.dt / (D.eps * D.Asr * rohl);
					...
					//L = Lvelho + (D.mliq[D.ii][D.jj] - GeraVap[D.ii][D.jj])*D.dt / (D.eps * D.Asr * rohl);
					L = (D.mliq[D.ii][D.jj] - GeraVap[D.ii][D.jj])*D.dt / (D.eps * D.Asr * rohl);
                    //DIFF2 = abs((L2 - L) / L2);
                    ...
                    /*if (contloop >= D.nmax)
                    {
                        ...
                        //cout << D.ii << " " << D.jj << " " << MsgResfriamento << endl;
