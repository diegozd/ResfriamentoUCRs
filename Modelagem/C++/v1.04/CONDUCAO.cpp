...
double CONDUCAO::CalcTsup(DADOS &D, PROPRIEDADES &PP, CONVECCAO &HLV)
{
	...
	{ 
		...
		cout << "D.Tsup[D.ii][D.jj] =  " << D.Tflu[D.ii][D.jj] << endl;
		cout << "HLV.h =  " << HLV.h << endl;
		cout << "HLV.Tbulk =  " << HLV.Tbulk << endl;
		cout << "Teta = " << teta << endl;
		
		
		cout << "Tsuper = " << Tsuper << endl;		
		cout << "D.Tsat = " << D.Tsat << endl;
		cout << "contloop = " << contloop << endl;		
		system ("pause");
	}*/
	

	
	if (Tsuper < D.Tflu[D.ii][D.jj] )
	{ 
		/*cout << "[ii] " << D.ii << " [jj] " << D.jj << endl;
		cout << "Tempo decorrido " << D.ii*D.dt/60 << endl;
		cout << "D.Tflu[D.ii][D.jj] =  " << D.Tflu[D.ii][D.jj] << endl;
